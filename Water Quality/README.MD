...
we built 5 different models using Rnn,lstm, lstm-rnn vs cnn to predict water quality using the below data
...
## Model architecture
![image](https://user-images.githubusercontent.com/31762490/202343363-0b1934d8-9587-4142-8447-f72975483a36.png)
